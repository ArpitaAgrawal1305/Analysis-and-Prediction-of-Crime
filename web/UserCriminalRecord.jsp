<%-- 
    Document   : UserCriminalRecord
    Created on : Oct 24, 2015, 5:54:48 PM
    Author     : USER
--%>
...
<html>
    ...
    <body>
        <form action="UserCriminalRecord2.jsp">
         <div id="mainDIv">
         <div id="mainDiv2">
            <div id="HeaderDiv">
      ...
      <%@ include file="Criminal_Record.jsp" %>
                            <table align="center">
                                <tr>
                                    ...
                                    <td colspan="2" align="center"><input type="submit" value="Next Page &Gt;" onclick="form.action='UserCriminalRecord2.jsp';" style="width: 150px; border-radius: 0px; background-color: greenyellow; margin-bottom: 10px;"></td>
                                </tr>
                            </table>  
                        </div>
                    </div>
