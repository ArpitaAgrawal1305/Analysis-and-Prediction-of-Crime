<%-- 
    Document   : UserCriminalRecord2
    Created on : Oct 25, 2015, 12:53:59 PM
    Author     : USER
--%>
...
<html>
    ...
    <body>
        <form action="UserCriminalRecord">
     <div id="mainDIv">
         <div id="mainDiv2">
            <div id="HeaderDiv">
           ...
           <table align="center">
                                <tr>
                                    <td colspan="2" align="center"><input type="submit" value="&Ll; Previous Page" onclick="form.action='UserCriminalRecord.jsp';" style="width: 150px; border-radius: 0px; background-color: greenyellow; margin-bottom: 10px;"></td>
