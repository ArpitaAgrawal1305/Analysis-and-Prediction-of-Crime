<%-- 
    Document   : DisplayUserImage
    Created on : Oct 24, 2015, 1:54:01 PM
    Author     : USER
--%>
...
<html>
 ...
 %>
 <%
id=(Integer)session1.getAttribute("user_id");

 %>
<%
   String sql1 = "SELECT image,imagename FROM user_detail WHERE user_id=?";
          ...
          //      id=result.getInt("reg_id");
             ...
             name=imagename;
             filepath= "C:\\Project\\Crime\\web\\UserProfilePicture\\"+name;
