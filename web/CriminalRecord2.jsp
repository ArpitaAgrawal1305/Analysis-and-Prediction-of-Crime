...
<%-- 
    Document   : CriminalRecord2
    Created on : Oct 17, 2015, 1:02:01 PM
    Author     : USER
--%>
...
<html>
    ...
    <body>
        ...
        <form action="CriminalRecord2">
           ...
           <%@ include file="Criminal_Record2.jsp" %>
           <table align="center">
                                <tr>
                                    <td colspan="2" align="center"><input type="submit" value="&Ll; Previous Page" onclick="form.action='CriminalRecord.jsp';" style="width: 150px; border-radius: 0px; background-color: greenyellow; margin-bottom: 10px;"></td>
                                    <td colspan="2" align="center"><input type="submit" value="Update" onclick="form.action='UpdateCriminalRecord2';" style="width: 150px; border-radius: 0px; background-color: greenyellow; margin-bottom: 10px;"></td>
                                </tr>
                            </table>  
                        </div>
